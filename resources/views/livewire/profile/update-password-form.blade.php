...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-5">
        <div>
            <x-input-label for="update_password_current_password" :value="__('Current Password')" class="text-sm font-medium text-slate-700" />
            ...
            <x-input-error :messages="$errors->get('current_password')" class="mt-1.5 text-xs text-red-600" />
        </div>

        <div>
            <x-input-label for="update_password_password" :value="__('New Password')" class="text-sm font-medium text-slate-700" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="text-sm font-medium text-slate-700" />
        ...
        <div class="flex items-center gap-4 pt-2">
            <x-primary-button wire:target="updatePassword">
